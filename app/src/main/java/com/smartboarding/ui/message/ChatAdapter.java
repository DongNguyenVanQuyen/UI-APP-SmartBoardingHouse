...
public class ChatAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public int getItemViewType(int position) {
        ...
        if (isImage) {
            return mine ? TYPE_SENT_IMAGE : TYPE_RECEIVED_IMAGE;
        }
        ...
        switch (viewType) {
            ...
            case TYPE_SENT_IMAGE:
                return new ImageViewHolder(
                        inflater.inflate(
                                R.layout.item_message_image_sent,
                                parent,
                                false
                        )
                );
            ...
            default:
                return new ImageViewHolder(
                        inflater.inflate(
                                R.layout.item_message_image_received,
                                parent,
                                false
                        )
                );
    ...
    static class ImageViewHolder extends RecyclerView.ViewHolder {
        ...
        void bind(Message m) {
            ...
            ivImage.setOnClickListener(v -> {
                ...
                intent.putExtra(
                        ImagePreviewActivity.EXTRA_IMAGE_URL,
                        m.imageUrl
                );
